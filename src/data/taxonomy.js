...
export const taxonomy = [
  {
    phylum: "Chordata",
    species: "65,000+",
    image: "https://res.cloudinary.com/davy75aew/image/upload/v1747915490/ChatGPT_Image_May_22_2025_05_24_08_PM_y1prnq.png",
    classes: [
      {
        name: "Mammalia",
        species: "6,400+",
        image: "https://res.cloudinary.com/davy75aew/image/upload/v1747918830/Gemini_Generated_Image_4tgnqe4tgnqe4tgn_oxblqc.png",
        description: "Warm-blooded vertebrates with hair or fur, and females produce milk.",
        families: [
          {
            name: "Felidae",
            species: "40+",
            image: "https://res.cloudinary.com/davy75aew/image/upload/v1747917374/felidae_mo9h3v.png",
            description: "Family of cats including lions, tigers, leopards, and domestic cats.",
            speciesList: [
              {
              id: "panthera-leo",
              name: "Lion",
          ...
          },
          {
            name: "Canidae",
            species: "35+",
            image: "https://res.cloudinary.com/davy75aew/image/upload/v1747932590/Canidae_jezy46.png",
            description: "Family of dogs including wolves, foxes, jackals, and domestic dogs.",
            speciesList: [
              {
                id: "canis-lupus",
                name: "Gray Wolf",
          ...
          }, 
          {
            name: "Ursidae",
            species: "8",
            image: "https://res.cloudinary.com/davy75aew/image/upload/v1747932600/Ursidae_u5kd0x.png",
            description: "Family of bears including polar bears, brown bears, and pandas.",
            speciesList: [
              {
                id: "ursus-arctos",
                name: "Brown Bear",
          ...
          },
          {
            name: "Cervidae",
            species: "90+",
            image: "https://res.cloudinary.com/davy75aew/image/upload/v1747932588/Cervidae_hastsz.png",
            description: "Family of deer including moose, elk, reindeer, and muntjacs.",
            speciesList: [{}]
          },
          {
            name: "Bovidae",
            species: "140+",
            image: "https://res.cloudinary.com/davy75aew/image/upload/v1747932606/Bovidae_dqvkq2.png",
            description: "Family including antelopes, gazelles, goats, sheep, and cattle.",
            speciesList: [{}]
          },
          {
            name: "Equidae",
            species: "7",
            image: "https://res.cloudinary.com/davy75aew/image/upload/v1747932609/Equidae_xlibdj.png",
            description: "Family of horses, zebras, and donkeys — herbivorous mammals with hooves.",
            speciesList: [{}]
          },
          {
            name: "Delphinidae",
            species: "90+",
            image: "https://res.cloudinary.com/davy75aew/image/upload/v1747932595/Delphinidae_cuzi7u.png",
            description: "Family of dolphins including orcas and pilot whales.",
            speciesList: [{}]
          },
          {
            name: "Phocidae",
            species: "18",
            image: "https://res.cloudinary.com/davy75aew/image/upload/v1747932595/Phocidae_lmdisl.png",
            description: "Family of true seals, adapted to aquatic life in polar and temperate regions.",
            speciesList: [{}]
          },
          {
            name: "Erinaceidae",
            species: "25+",
            image: "https://res.cloudinary.com/davy75aew/image/upload/v1747932605/Erinaceidae_f6rtp2.png",
            description: "Family including hedgehogs and gymnures, known for spines and insectivorous diets.",
            speciesList: [{}]
          },
          {
            name: "Sciuridae",
            species: "280+",
            image: "https://res.cloudinary.com/davy75aew/image/upload/v1747932603/Sciuridae_wgbvsy.png",
            description: "Family of squirrels including tree squirrels, ground squirrels, and chipmunks.",
            speciesList: [{}]
          }
      ...
      },
      {
        name: "Aves",
        species: "10,000+",
        image: "https://res.cloudinary.com/davy75aew/image/upload/v1747920321/aves_d0gye1.png",
        description: "Feathered, warm-blooded vertebrates. Most can fly, and all lay eggs.",
        families: [{}]
      },
      {
        name: "Reptilia",
        species: "11,000+",
        image: "https://res.cloudinary.com/davy75aew/image/upload/v1747920264/Reptilia_thcqin.png",
        description: "Cold-blooded vertebrates with scales or scutes. Includes snakes, lizards, and turtles.",
        families: [{}]
      },
      {
        name: "Amphibia",
        species: "8,000+",
        image: "https://res.cloudinary.com/davy75aew/image/upload/v1747920268/Amphibia_y8afru.png",
        description: "Cold-blooded vertebrates living part of their life in water and part on land. Includes frogs and salamanders.",
        families: [{}]
      },
      {
        name: "Actinopterygii",
        species: "30,000+",
        image: "https://res.cloudinary.com/davy75aew/image/upload/v1747920269/Actinopterygii_u48yxq.png",
        description: "Ray-finned fishes — the largest class of vertebrates. Includes goldfish, tuna, and salmon.",
        families: [{}]
      },
      {
        name: "Chondrichthyes",
        species: "1,200+",
        image: "https://res.cloudinary.com/davy75aew/image/upload/v1747920269/Chondrichthyes_kwd9dm.png",
        description: "Cartilaginous fishes like sharks, rays, and skates. Skeletons made of cartilage.",
        families: [{}]
      },
      {
        name: "Cephalochordata",
        species: "30+",
        image: "https://res.cloudinary.com/davy75aew/image/upload/v1747920261/Cephalochordata_rj3wyn.png",
        description: "Small fish-like marine animals like lancelets. They retain all chordate features in adulthood.",
        families: [{}]
      },
      {
        name: "Urochordata",
        species: "2,000+",
        image: "https://res.cloudinary.com/davy75aew/image/upload/v1747930203/Gemini_Generated_Image_5njmtg5njmtg5njm_d8hmbj.png",
        description: "Also known as tunicates or sea squirts. Larvae show chordate traits like a notochord and tail.",
        families: [{}]
      }
      // Add more classes like Aves, Reptilia, Amphibia...
    ],
  },
  // Add more phyla like Arthropoda, Mollusca...
];
